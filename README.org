...
** Java
The 'dape-jdtls' extension offers a working configuration with basic
debugging functionality. Only main classes/methods can be used as
entrypoints for now.
*** Requirements
**** JDK version 17+
Install with JAVA_HOME set and binaries on PATH.

**** Eclipse JDT Language Server
Installed with binaries on PATH.
...
**** VS Code Test Runner for Java (can be skipped while integration is WIP)
